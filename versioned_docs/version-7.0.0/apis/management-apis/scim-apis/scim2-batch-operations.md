...
Follow the topics given below to understand how **Bulk** operations can be used when you manage resources in the [SCIM2 API](/apis/scim2-bulk-rest-apis/#tag/Bulk-Endpoint).
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           <td>
           <code>failOnErrors</code>
           </td>
           <td>Optional</td>
           <td>
           The number of errors that will be accepted by WSO2 IS before returning the response.<br />
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           This is the schema that is required for sending bulk requests:<br />
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To add multiple new users, add an array of POST operations. You can include any number of operations in one bulk request.<br />
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           This is the schema that is required for sending bulk requests:<br /><br />
           <code>urn:ietf:params:scim:api:messages:2.0:BulkRequest</code>.
           </td>
       </tr>
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To update multiple users, add an array of PATCH operations. You can include any number of operations in one bulk request.<br /><br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To replace multiple users, add an array of PUT operations. You can include any number of operations in one bulk request.<br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of  operations. To delete multiple users, add an array of DELETE operations. You can include any number of operations in one bulk request.<br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To add multiple new user groups, add an array of POST operations. You can include any number of operations in one bulk request.<br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To update multiple user groups, add an array of PATCH operations. You can include any number of operations in one bulk request.<br /><br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Data operation value parameters
    ...
    <table>
        <tr>
           <td><code>display</code></td>
           <td>
           Required if <code>path</code> is set to <code>members</code>.
           </td>
           <td>
       ...
       <tr>
           <td><code>value</code></td>
           <td>Required if <code>path</code> is set to <code>members</code>.</td>
           <td>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of operations. To replace multiple user groups, add an array of PUT operations. You can include any number of operations in one bulk request.<br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
...
-   Main parameters
    ...
    <table>
       ...
       <tr>
           ...
           <td>Required</td>
           <td>
           Array of  operations. To delete multiple user groups, add an array of PUT operations. You can include any number of operations in one bulk request.<br />
           The parameters that can be used for the operation are explained below.
           </td>
       </tr>
    </table>
